 ...
 * @author jeffrey
 */
public class ParamsElementComplex extends ParamsElement {
    public ParamsElementComplex(JSONObject schemaDefn, Object paramsContainer, PanelProperties cb, int arrIndex, String addr){
        ...
        callback.registerAnimationParamType(new AnimationWindow.AnimationParam(addr, 
                AnimationWindow.AnimationParamType.APT_COMPLEX, schem));
    }
